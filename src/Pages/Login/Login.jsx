  ...
  return (
    <div className="my-container my-20">
      <div className="divide divide-y divide-slate-900 mb-20">
        <h2 className="text-4xl font-thin text-slate-900 uppercase pb-5">
          CUSTOMER LOGIN
        </h2>
        <hr />
      </div>
      <div className="w-4/5 md:w-2/5 mx-auto">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-between items-center">
            <div className="w-2/5">
              <input
                className="block bg-red-800 text-white font-bold text-lg w-full py-3 rounder cursor-pointer"
                type="submit"
                value="Login"
              />
            </div>
        ...
        <div className="mt-8 text-center">
          <h4 className="divide-current divide-x-2 divide-slate-800">
            Or Login With
          </h4>
          <button
            onClick={handleGoogleLogin}
            className="btn bg-red-800 btn-circle text-white font-bold text-xl mt-5"
          >
            {" "}
            <h3>G</h3>
          </button>
